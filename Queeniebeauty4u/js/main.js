;(function($) {
    ...
    var homeSlider = function() {
      // var hHeader = $(window).height() - $('#header').height();
      //   $('#slider .t-slider-wrap').css('height', hHeader);
        $('#slider .sliders').slick({
            ...
            fade: true,
            arrows: true,
            prevArrow: '<div class="btn-prev"><span class="hcj-icon-angle-left"></span></div>',
            nextArrow: '<div class="btn-next"><span class="hcj-icon-angle-right"></span></div>',
            dots: true,
        });
    }
